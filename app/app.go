...
func NewOKExChainApp(
	...
	app.SetParallelTxHandlers(updateFeeCollectorHandler(app.BankKeeper, app.SupplyKeeper), evmTxFeeHandler(), fixLogForParallelTxHandler(app.EvmKeeper), preLoadSender(app.AccountKeeper, app.GetKey("acc")))
